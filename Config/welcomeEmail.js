exports.WelcomeEmail = function (result, callback) {
    ...
    <tbody style="margin-top: 15px;">
      <tr class="">
    <td class="">
    <img alt="robot picture" class="" height="155" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Louis_Vuitton_logo_and_wordmark.svg/800px-Louis_Vuitton_logo_and_wordmark.svg.png" width="155">
    </td>
    </tr>
    <tr class=""><td class="headline">Welcome to the Fashion!</td></tr>
    <tr>
    <td>
    <center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
    <td class="" style="color:#444; font-weight: 400;"><br><br>
    
      You have successfully been registered to Fashion<br>
      <br>
      As you know now you have become a member of the fashion community we will be glad to serve you. <br>
    ...
    <td class="">
    <div class="">
    <a style="background-color: #008178;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;" href="http://localhost:3000/" target="_blank">Explore</a>
    </div>
     <br>
    </td>
    </tr>
